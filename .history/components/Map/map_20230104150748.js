...
export default function Map() {
    ...
    return (
        <MapContainer className={style.map} center={position} zoom={14} scrollWheelZoom={true}>
            ...
            <Marker position={[49.2862526257819, -123.1202039]} pathOptions={blueOption}>
            ...
            <Marker position={[49.28013284319446, -123.11014287862584]} pathOptions={blueOption}>
                <Popup>Stadium-Chinatown Station<br/>Expo Line</Popup>
            </Marker>

            
            <Marker position={[49.273318980467025, -123.10037145958005]} pathOptions={blueOption}>
                <Popup>Main Street-Science World Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.2627770134397, -123.06919358656506]} pathOptions={blueOption}>
                <Popup>Commercial-Broadway Station<br/>Expo Line</Popup>
            </Marker>

            
            <Marker position={[49.24841124748144, -123.055842200058]} pathOptions={blueOption}>
                <Popup>Nanaimo Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.24434236679643, -123.04542767492465]} pathOptions={blueOption}>
                <Popup>29th Ave Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.238527289117606, -123.03180071725312]} pathOptions={blueOption}>
                <Popup>Joyce-Collingwood Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.22992666226876, -123.01272618921564]} pathOptions={blueOption}>
                <Popup>Patterson Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.22591186740195, -123.00391564608952]} pathOptions={blueOption}>
                <Popup>Metrotown Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.22022674217617, -122.988486726947122]} pathOptions={blueOption}>
                <Popup>Royal Oak Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.21276468206421, -122.95933430532412]} pathOptions={blueOption}>
                <Popup>Edmonds Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.2002694713839, -122.94923127907236]} pathOptions={blueOption}>
                <Popup>22nd Street Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.20176121342438, -122.91268977631553]} pathOptions={blueOption}>
                <Popup>New Westminster Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.20521830518485, -122.9060229478834]} pathOptions={blueOption}>
            ...
            <Marker position={[49.20587142351246, -122.87435173718517]} pathOptions={blueOption}>
            ...
            <Polyline pathOptions={blueOption} positions={surreyline}/>
