...
export default function Map() {
    ...
    return (
        <MapContainer className={style.map} center={position} zoom={14} scrollWheelZoom={true}>
            ...
            <Marker position={[49.23299466100193, -122.88290531725335]} pathOptions={purpleOption}>
                <Popup>Braid Station<br/>Expo Line</Popup>
            </Marker>

            <Marker position={[49.248814953016954, -122.89720949397046]} pathOptions={purpleOption}>
                <Popup>Lougheed Town Centre Station<br/>Milleniun Line & Expo Line</Popup>
            </Marker>

            <Marker position={[49.25367127330616, -122.9187357167187]} pathOptions={purpleOption}>
